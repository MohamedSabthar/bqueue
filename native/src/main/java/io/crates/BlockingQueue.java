...
/**
 * Native implementation of the crates/blocking-queue module.
 */
public class BlockingQueue {
    ...
    public static Object put(BObject bObject, Object value) {
        try {
            LinkedBlockingQueue<Object> queue = (LinkedBlockingQueue<Object>) bObject.getNativeData(QUEUE);
            queue.put(value);
            return null;
        } catch (InterruptedException e) {
            BString errorMessage = StringUtils.fromString("Error while putting element to queue: " + e.getMessage());
    ...
    public static Object take(Environment environment, BObject bObject, Object timeout, BTypedesc typedesc) {
        ...
        try {
            ...
            environment.getRuntime()
                    .invokeMethodAsyncConcurrently(bObject, DATA_BINDING_FUNCTION, null, null, callback, null, TYPE_ANY,
                                                   args);
            return null;
        } catch (InterruptedException e) {
            BString errorMessage = StringUtils.fromString("Error while taking element from queue: " + e.getMessage());
    ...
    public static Object peek(Environment environment, BObject bObject, BTypedesc typedesc) {
        ...
        environment.getRuntime()
                .invokeMethodAsyncConcurrently(bObject, DATA_BINDING_FUNCTION, null, null, callback, null, returnType,
                                               args);
        return null;
    }
}
